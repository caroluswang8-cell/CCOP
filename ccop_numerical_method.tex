...
\section{Case 2: Long-time ISPH comparison under matched spatial discretization}
\label{sec:result2}
...
without repeating that one-step ablation.  Spatial reconstruction is
deliberately prevented from setting the accuracy floor by using the
two-dimensional conservative affine drop under a central potential force.  The
...
\subsection{Matched ISPH--CCOP comparison}
